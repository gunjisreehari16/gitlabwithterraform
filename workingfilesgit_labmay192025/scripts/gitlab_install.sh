...
timeout_cmd "$TIMEOUT" systemctl enable firewalld --now
timeout_cmd "$TIMEOUT" firewall-cmd --permanent --add-service=http
timeout_cmd "$TIMEOUT" firewall-cmd --permanent --add-service=https
timeout_cmd "$TIMEOUT" firewall-cmd --permanent --add-service=ssh
timeout_cmd "$TIMEOUT" firewall-cmd --reload
